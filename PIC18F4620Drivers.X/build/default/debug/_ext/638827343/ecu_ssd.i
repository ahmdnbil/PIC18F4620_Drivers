...
# 2 "<built-in>" 2
# 1 "../ECU_layer/SSD/ecu_ssd.c" 2
# 12 "../ECU_layer/SSD/ecu_ssd.c"
# 1 "../ECU_layer/SSD/./ecu_ssd.h" 1
# 17 "../ECU_layer/SSD/./ecu_ssd.h"
# 1 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/hal_gpio.h" 1
# 16 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/hal_gpio.h"
...
# 16 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/../mcal_std_types.h" 1
# 17 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/../mcal_std_types.h"
# 1 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/.././std_libraries.h" 1
# 16 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/.././std_libraries.h"
...
# 16 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/.././std_libraries.h" 2
...
# 17 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/.././std_libraries.h" 2
# 17 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/../mcal_std_types.h" 2

# 1 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/.././mem_map.h" 1
# 17 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/.././mem_map.h"
...
# 18 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/../mcal_std_types.h" 2

# 1 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/.././compiler.h" 1
# 14 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/.././compiler.h"
...
# 14 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/.././compiler.h" 2
# 19 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/../mcal_std_types.h" 2
# 17 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/../device_config.h" 1
# 18 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/hal_gpio.h" 2

# 1 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/./hal_gpio_cfg.h" 1
# 19 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/hal_gpio.h" 2
# 38 "../ECU_layer/SSD/./../../MCAL_layer/GPIO/hal_gpio.h"
typedef enum{
    LOW=0,
    HIGH
}logic_t;
...
Std_ReturnType ssd_initalize(const ssd_t *ssd)
{
    ...
    {
        ret=gpio_pin_initalize(&(ssd->ssd_pins[0]));
        ret=gpio_pin_initalize(&(ssd->ssd_pins[1]));
        ret=gpio_pin_initalize(&(ssd->ssd_pins[2]));
        ret=gpio_pin_initalize(&(ssd->ssd_pins[3]));
...
{
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if((((void*)0) == ssd) || (number<=9))
    {
        ret=(Std_ReturnType)0x00;
    }
    else
    {
        ret = gpio_pin_write_logic(&(ssd->ssd_pins[0]), (number >> 0) & (uint8)0x01);
        ret = gpio_pin_write_logic(&(ssd->ssd_pins[1]), (number >> 1) & (uint8)0x01);
        ret = gpio_pin_write_logic(&(ssd->ssd_pins[2]), (number >> 2) & (uint8)0x01);
        ret = gpio_pin_write_logic(&(ssd->ssd_pins[3]), (number >> 3) & (uint8)0x01);
    }
    return ret;
}
