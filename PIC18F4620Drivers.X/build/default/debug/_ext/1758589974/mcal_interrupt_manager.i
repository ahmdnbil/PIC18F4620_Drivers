...
# 51 "../MCAL_layer/interrupt/mcal_interrupt_manager.c"
void __attribute__((picinterrupt(("")))) InterruptManagerHigh(void)
{
    if ((INTCONbits.INT0IE == 1U) && (INTCONbits.INT0IF == 1U))
    {
        EXTI0_ISR();
    }
    else if ((INTCON3bits.INT1E == 1U) && (INTCON3bits.INT1F == 1U))
    {
        EXTI1_ISR();
    }
    else if ((INTCON3bits.INT2E == 1U) && (INTCON3bits.INT2F == 1U))
    {
        EXTI2_ISR();
    }


    else if ((1U == INTCONbits.RBIE) && (1U == INTCONbits.RBIF) && (PORTBbits.RB4 == HIGH) && (1 == RB4_enter))
    {
        RB4_ISR(1);
        RB4_enter = 0;
    }
    else if ((1U == INTCONbits.RBIE) && (1U == INTCONbits.RBIF) && (PORTBbits.RB4 == LOW) && (0 == RB4_enter))
    {
        RB4_ISR(0);
        RB4_enter = 1;
    }

    else if ((1U == INTCONbits.RBIE) && (1U == INTCONbits.RBIF) && (PORTBbits.RB5 == HIGH) && (1 == RB5_enter))
    {
        RB5_ISR(1);
        RB5_enter = 0;
    }
    else if ((1U == INTCONbits.RBIE) && (1U == INTCONbits.RBIF) && (PORTBbits.RB5 == LOW) && (0 == RB5_enter))
    {
        RB5_ISR(0);
        RB5_enter = 1;
    }

    else if ((1U == INTCONbits.RBIE) && (1U == INTCONbits.RBIF) && (PORTBbits.RB6 == HIGH) && (1 == RB6_enter))
    {
        RB6_ISR(1);
        RB6_enter = 0;
    }
    else if ((1U == INTCONbits.RBIE) && (1U == INTCONbits.RBIF) && (PORTBbits.RB6 == LOW) && (0 == RB6_enter))
    {
        RB6_ISR(0);
        RB6_enter = 1;
    }

    else if ((1U == INTCONbits.RBIE) && (1U == INTCONbits.RBIF) && (PORTBbits.RB7 == HIGH) && (1 == RB7_enter))
    {
        RB7_ISR(1);
        RB7_enter = 0;
    }
    else if ((1U == INTCONbits.RBIE) && (1U == INTCONbits.RBIF) && (PORTBbits.RB7 == LOW) && (0 == RB7_enter))
    {
        RB7_ISR(0);
        RB7_enter = 1;
    }
    ...
    else if ((1U == PIE1bits.ADIE) && (1U == PIR1bits.ADIF))
    {



    }
    else if ((1U == INTCONbits.T0IE) && (1U == INTCONbits.T0IF))
    {

        TIMER0_ISR();

    }
    else if ((1U == PIE1bits.TMR1IE) && (1U == PIR1bits.TMR1IF))
    {

        TIMER1_OVF_ISR();

    }
    else if ((1U == PIE1bits.TMR2IE) && (1U == PIR1bits.TMR2IF))
    {



    }
    else if ((1U == PIE2bits.TMR3IE) && (1U == PIR2bits.TMR3IF))
    {
