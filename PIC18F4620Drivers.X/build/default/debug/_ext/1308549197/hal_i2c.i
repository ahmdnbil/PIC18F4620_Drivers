...
# 17 "../MCAL_layer/I2C/./../mcal_std_types.h"
# 1 "../MCAL_layer/I2C/./.././std_libraries.h" 1
# 16 "../MCAL_layer/I2C/./.././std_libraries.h"
...
# 17 "../MCAL_layer/I2C/./../mcal_std_types.h" 2

# 1 "../MCAL_layer/I2C/./.././mem_map.h" 1
# 17 "../MCAL_layer/I2C/./.././mem_map.h"
...
# 18 "../MCAL_layer/I2C/./../mcal_std_types.h" 2
...
# 18 "../MCAL_layer/I2C/./../interrupt/./mcal_interrupt_cfg.h" 2
# 51 "../MCAL_layer/I2C/./../interrupt/./mcal_interrupt_cfg.h"
typedef enum
{
    INTERRUPT_LOW_PRIORITY=0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 16 "../MCAL_layer/I2C/./../interrupt/mcal_internal_interrupt.h" 2
...
# 12 "../MCAL_layer/I2C/hal_i2c.c" 2



static __attribute__((inline)) void mssp_i2c_select_mode(const mssp_i2c_t *_i2c);
static __attribute__((inline)) void mssp_interrupt_handler_cfg(const mssp_i2c_t *_i2c);
static void (*I2C_DEFAULT_INTERRUPT_HANDLER)(void) = ((void*)0);
static void (*I2C_OVERFLOW_INTERRUPT_HANDLER)(void) = ((void*)0);
static void (*I2C_WRITE_COLLISION_INTERRUPT_HANDLER)(void) = ((void*)0);
...
static __attribute__((inline)) void mssp_i2c_select_mode(const mssp_i2c_t *_i2c)
{
    ...
    case 0x01:
        ...
        SSPADD = (uint8)(((8000000UL / 4.0) / _i2c->i2c_clk) - 1);


        (SSPCON1bits.SSPM = _i2c->i2c_config.i2c_mode_config);
        break;
    ...
    case 0x00:
        ...
        SSPCON1bits.WCOL = 0x00;


        SSPCON1bits.SSPOV = 0x00;
...
void MSSP_I2C_ISR()
{
    ...
    if (((void*)0) != I2C_DEFAULT_INTERRUPT_HANDLER)
    {
...
void MSSP_I2C_BC_ISR()
{
    ...
    if (((void*)0) != I2C_WRITE_COLLISION_INTERRUPT_HANDLER)
    {
